<!-- jQuery -->
<script src="<?php echo RELATIVE_PATH.'/vendors/jquery/dist/jquery.min.js'?>"></script>
...
<script src="<?php echo RELATIVE_PATH.'/dist/js/feather.min.js'?>"></script>
<!-- Fancy Dropdown JS -->
...
<!-- Init JavaScript -->
<script src="<?php echo RELATIVE_PATH.'/dist/js/init.js'?>"></script>
<script src="<?php echo RELATIVE_PATH.'/dist/js/login-data.js'?>"></script>
</body>
